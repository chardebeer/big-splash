...
class CFWJM_Admin {
	...
	public function __construct () {
		...
		$this->diable_arr = array('radio','checkbox','select','multiselect');
						...
						<table class="form-table">
							<tr>
								...
								<td>
									...
									<a href="https://www.codesmade.com/store/custom-field-for-wp-job-manager-pro/" target="_blank">Get Pro For Radio,Select and checkbox field</a>
								</td>
							</tr>
							<tr>
