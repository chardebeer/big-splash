	...
	public function settings_tab( $settings ) {
		...
		$settings['wpjmr_settings'] = array(
			...
			array(
				...
				array(
					'name'          => 'wpjmr_star_default',
					'std'           => '3',
					'placeholder'   => '',
					'label'         => __( 'Default Star', 'wp-job-manager-reviews' ),
					'desc'          => __( 'Initial selected star value.', 'wp-job-manager-reviews' ),
					'attributes'    => array()
				),
				array(
				...
				array(
					'name'          => 'wpjmr_restrict_emails',
					'std'           => '0',
					'placeholder'   => '',
					'label'         => __( 'Restrict Sending Email', 'wp-job-manager-reviews' ),
					'cb_label'      => __( 'Stop sending emails', 'wp-job-manager-reviews' ),
					'desc'          => __( '', 'wp-job-manager-reviews' ),
					'attributes'    => array(),
					'type'          => 'checkbox'
				),
			),
